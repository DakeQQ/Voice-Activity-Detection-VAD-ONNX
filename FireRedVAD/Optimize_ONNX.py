...
# Path Setting
original_folder_path = "/home/DakeQQ/Downloads/FireRedVAD_ONNX"                         # The fp32 saved folder.
optimized_folder_path = "/home/DakeQQ/Downloads/FireRedVAD_Optimized"                   # The optimized folder.
model_names = ["FireRedVAD.onnx", "FireRedAED.onnx", "FireRedStreamVAD.onnx"]           # The three exported model names.
use_fp16 = False                                                                        # Set True for fp16 quant.
opset = 0                                                                               # Upgrade the Opset version. Set opset <= 0 for disable. (optional process)


for model_name in model_names:
    model_path = os.path.join(original_folder_path, model_name)
    optimized_model_path = os.path.join(optimized_folder_path, model_name)
    ...
    print(f"Done: {optimized_model_path}")